                ...
                <CollapsibleContent className=" space-y-1">
                  {section.lessons.map((lesson) => (
                    <button
                      ...
                      className={`w-full text-left p-3 sm:p-4 text-sm sm:text-base flex justify-between items-center transition-colors duration-300 rounded-lg ${activeLessonId === lesson.id
