...
const sectionClasses = "hero h-full px-6 md:px-16 pt-20 pb-10 flex flex-col md:flex-row items-center justify-between gap-12";
...
const subtitleClasses = "text-zinc-600 text-xl";
