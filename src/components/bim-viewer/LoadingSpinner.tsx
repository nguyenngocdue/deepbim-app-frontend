  ...
  return (
    <div className="absolute inset-0 flex flex-col items-center justify-center z-50 bg-black/10 backdrop-blur-sm">
      ...
      <div className="relative w-20 h-20 mb-8">
        <div className="absolute inset-0 border-4 border-t-green-500 border-r-transparent border-b-transparent border-l-transparent rounded-full animate-spin [animation-duration:1s]" />
      ...
      {/* Progress Bar */}
      <div className="relative w-72 h-4 bg-indigo-100/20  rounded-full overflow-hidden shadow-inner">
        <div
      ...
      {/* Percentage */}
      <p className="mt-4 text-lg font-medium text-purple-500 tracking-wider">
        {Math.round(progress)}%
      </p>
    </div>
  );
