...
const WebglClippingBVH: React.FC = () => {
    const mountRef = useRef<HTMLDivElement>(null);
    const initializedRef = useRef(false); // Kiểm tra nếu đã khởi tạo
    ...
    useEffect(() => {
        ...
        let bvhHelper: MeshBVHHelper | null = null;
        let colliderBvh: MeshBVH | null = null;
        let clippingPlanes: THREE.Plane[] = [];
        let outlineLines: THREE.LineSegments;
...
export default WebglClippingBVH;
